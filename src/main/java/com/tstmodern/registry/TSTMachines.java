...
/**
 * Machine definitions. This is the copyable base for later TST multiblock
 * ports.
 */
public final class TSTMachines {
        ...
        public static final MultiblockMachineDefinition GIANT_VACUUM_DRYING_FURNACE = TSTModern.REGISTRATE
                        ...
                        .tooltips(
                                        Component.translatable(
                                                        "tstmodern.machine.giant_vacuum_drying_furnace.tooltip.0"),
                                        Component.translatable(
                                                        "tstmodern.machine.giant_vacuum_drying_furnace.tooltip.1"),
                                        Component.translatable(
                                                        "tstmodern.machine.giant_vacuum_drying_furnace.tooltip.2"),
                                        Component.translatable(
                                                        "tstmodern.machine.giant_vacuum_drying_furnace.tooltip.3"))
                        .register();
        ...
        public static final MultiblockMachineDefinition NETHER_INTERFACE = TSTModern.REGISTRATE
                ...
                public static final MultiblockMachineDefinition HYPER_THERMAL_CONVECTOR = TSTModern.REGISTRATE
...
.aisle(
        ...
        /**
         * Triggers static initialization of machine definitions when GTCEu opens its
         * machine registry.
         * The method body is intentionally empty: loading this class registers all
         * static
         * {@link MultiblockMachineDefinition} fields above.
         */
        public static void registerMachines(GTCEuAPI.RegisterEvent<ResourceLocation, MachineDefinition> event) {
                // Intentionally empty — class loading registers all static
                // MultiblockMachineDefinition fields.
        }
}
