...
/** Keeps B-role hatches on Advanced Iridium Casing and C-role hatches on Radiant Naquadah Alloy Casing. */
public final class LargeNeutronOscillatorPartRender
        extends DynamicRender<WorkableElectricMultiblockMachine, LargeNeutronOscillatorPartRender>
        implements IControllerModelRenderer {

    public static final Codec<LargeNeutronOscillatorPartRender> CODEC = Codec.unit(LargeNeutronOscillatorPartRender::new);
    public static final DynamicRenderType<WorkableElectricMultiblockMachine, LargeNeutronOscillatorPartRender> TYPE =
            new DynamicRenderType<>(CODEC);

    private final Map<BlockState, BakedModel> models = new HashMap<>();

    @Override
    public DynamicRenderType<WorkableElectricMultiblockMachine, LargeNeutronOscillatorPartRender> getType() {
        return TYPE;
    }
    ...
    public void renderPartModel(List<BakedQuad> quads, IMultiController controller, IMultiPart part,
        ...
        BlockState state = LargeNeutronOscillatorDefinition.partAppearance(controller, part, side);
